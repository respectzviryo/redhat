...
#obj = Soap.new#(endpoint_url)
#
#puts obj.getUserInfo(GetUserInfo.new).inspect
...
obj.headerhandler << MyHandler.new("urn:partner.soap.sforce.com", 'SessionHeader', '00D20000000OIfH!AR4AQJUczvzTWNRI8tqTvmC_TAIJALPpNdYM7hlMQNHrUlAFw_I_oy2xTCquNeQLum0bDZhSeTrrS5KpDbgMd8eURYEBEgrG')
obj.headerhandler << MyHandler.new("urn:partner.soap.sforce.com", 'CallOptions', '')


puts obj.getUserInfo(GetUserInfo.new)