...
access_token = "00D20000000OIfH!AR4AQITF8OIDF715H1ao8waYQ0Am4jkccymaSc5ViO4VruJ3vAgjdMu3yIj4ROErTxIXNl5E7iYVQsXxVCz2TQxFoQTxjhW2"
obj = Soap.new(endpoint_url)
obj.headerhandler << Salesforce::ClientAuthHeaderHandler.new(access_token)
...
s.set_any({"firstName" => "Loader"})

obj.update("sObjects" => [s])
